...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Widget image(){
    return Container(
      ...
      child: Lottie.asset('assets/images/new-password.json',),
    );
  }
   ...
   return Material(
      ...
      child:TextFormField(
        ...
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.email, color: Colors.redAccent[100], size: 20),
  ...
  Widget button() {
    return !_load ? RaisedButton(
      ...
      child: Container(
        ...
        child: Text('Reset Password',style: TextStyle(fontSize: 15,fontFamily: "NotoSerif-Bold")),
      ),
    ) : Center(
